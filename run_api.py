#!/usr/bin/env python3
"""
FastAPI server runner for Vietnamese Business Registration RAG Chatbot.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Vietnamese Business Registration RAG Chatbot API Server")
